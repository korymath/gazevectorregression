...
figure; imagesc(errMeanAllMean, [0 20]); colorbar; colormap(jet);
figure; imagesc(errMeanSweepMean, [0 20]); colorbar; colormap(jet);
figure; imagesc(errMeanGridMean, [0 20]); colorbar; colormap(jet);